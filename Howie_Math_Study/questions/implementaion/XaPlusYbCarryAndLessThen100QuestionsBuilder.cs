...
{
    internal class XaPlusYbCarryAndLessThen100QuestionsBuilder : BaseQuestionBuilder, IXaPlusYbCarryAndLessThen100QuestionsBuilder
    {
        public XaPlusYbCarryAndLessThen100QuestionsBuilder(IRandom rd) : base(rd)
        {
        }
