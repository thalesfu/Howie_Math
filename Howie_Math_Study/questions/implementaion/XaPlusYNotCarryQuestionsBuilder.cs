...
{
    internal class XaPlusYNotCarryQuestionsBuilder : BaseQuestionBuilder, IXaPlusYNotCarryQuestionsBuilder
    {
        public XaPlusYNotCarryQuestionsBuilder(IRandom rd) : base(rd)
        {
        }
