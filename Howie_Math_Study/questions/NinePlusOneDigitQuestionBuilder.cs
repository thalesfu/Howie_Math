...
{
    public class NinePlusOneDigitQuestionBuilder : INinePlusOneDigitQuestionBuilder
    {
        private readonly IRandom rd;

        private int[] GroupA = {9};
        private int[] GroupB = {1, 2, 3, 4, 5, 6, 7, 8, 9};

        public NinePlusOneDigitQuestionBuilder(IRandom rd)
        {
            this.rd = rd;
        }
